# COMMAND: EdgeVec META_ARCHITECT
...
### Trigger: `@META_ARCHITECT design [component]`

Execute architecture design for specified component.

### Trigger: `@META_ARCHITECT review [document]`

Review existing architecture document for gaps.

### Trigger: `@META_ARCHITECT validate [claim]`

Verify a technical claim with sources.
...
Next: HOSTILE_REVIEWER to validate before PLANNER creates roadmap.
```
