...
- Approved ARCHITECTURE.md (internal version)
- Benchmark results
...
### Trigger: `@DOCWRITER readme`

Generate/update README.md.

### Trigger: `@DOCWRITER api [module]`

Generate API documentation for module.

### Trigger: `@DOCWRITER changelog [version]`

Generate changelog for version.

### Trigger: `@DOCWRITER examples`

Create/update example code.
