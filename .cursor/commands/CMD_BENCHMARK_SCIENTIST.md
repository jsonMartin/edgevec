# COMMAND: EdgeVec BENCHMARK_SCIENTIST
...
- `ARCHITECTURE.md` — Performance budget reference
...
### Trigger: `@BENCHMARK_SCIENTIST baseline [component]`

Establish baseline metrics for component.

### Trigger: `@BENCHMARK_SCIENTIST compare [competitor]`

Run comparison benchmarks against competitor.

### Trigger: `@BENCHMARK_SCIENTIST regression`

Check for regressions against baseline.

### Trigger: `@BENCHMARK_SCIENTIST report`
