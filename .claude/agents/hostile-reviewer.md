...
description: Final quality gate with maximum hostility validation and ultimate veto power
version: 2.0.0
tools:
  - Read
  - Write
...
# HOSTILE_REVIEWER Agent Definition
...
4. Resubmit for hostile review via /review [artifact]
...
Gate File Created: .claude/GATE_[N]_COMPLETE.md
```
